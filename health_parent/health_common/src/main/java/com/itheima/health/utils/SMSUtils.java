 ...
 * 短信发送工具类
 * AccessKey ID
 * LTAI4G1hYY8haHjHKouRkfi8
 * AccessKey Secret
 * kg3T8wTX9ltQhtl4FrS7pmB4FBV8SD
 */
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203725619";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "ABC商城";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4G1hYY8haHjHKouRkfi8"; //你的AccessKey ID
	private static final String SECRET_KEY="kg3T8wTX9ltQhtl4FrS7pmB4FBV8SD"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"15323782718","dasb");
	}
