...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "saql0QBjP33hdqakvwgmWapHX3_Fir457eUxmXX9";
    private static final String SECRETKEY = "q--wMZ_tiz26akAmjAPt_z1GgGkocnT0fFSmEQ1f";
    private static final String BUCKET = "gjw100";
    public static final String DOMAIN= "http://qh05wowsk.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("D:\\gjw.jpg","hahhahahhhahahahhahahahahhahahaha.jpg");
